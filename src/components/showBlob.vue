<template lang="pug">
  .show-blob
    div.relative(style='z-index:100;')
    ...
    div(v-if='selectEmotion')
      ...
      construct-blob(:nb_points='parseInt(selectEmotion.nbPoint)', :complexite='selectEmotion.complexite', :couleur_debut='selectEmotion.couleurDebut', :couleur_fin='selectEmotion.couleurFin', :transition='selectEmotion.transition')
</template>
